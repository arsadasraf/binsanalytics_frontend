...
function HRPageContent() {
  ...
  const activeTab = (searchParams.get("tab") as "home" | "master") || "home";

  // State for Master sub-tabs
  const [activeMasterTab, setActiveMasterTab] = useState<"department" | "designation" | "employee" | "skills">("department");
